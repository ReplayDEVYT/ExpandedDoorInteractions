...
namespace SPTOpenSesame
{
    ...
    public class OpenSesamePlugin : BaseUnityPlugin
    {
        ...
        private void addConfigOptions()
        {
            ...
            AddDoNothingAction = Config.Bind("Main", "Add Open Further action to menus",
                true, "Adds the \"Open Further\" action to context menus where applicable so you can open peeked doors.");
